...
function ExpenseForm({ submitButtonLabel, onCancel, onSubmit, defaultValues }) {
  ...
  function inputChangedHandler(inputIdentifier, enteredValue) {
    setInputs((curInputs) => {
      return {
        ...curInputs,
        [inputIdentifier]: { value: enteredValue, isValid: true }, // target a specific property dynamically using the identifier (in this case either 'amount', 'date' or 'description')
      };
    });
  }
  ...
  function submitHandler() {
    const expenseData = {
      ...
      date: new Date(inputs.date.value), // works provided date matches the format of YYYY-MM-DD a new date object can be created
